...
/*   Updated: 2026/09/09 18:58:09 by jihaneasmoun     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ast_to_cmd.h"

static bool	convert_cmd(t_data *data, t_node *tree,\
	t_command **head, t_command **last)
{
	t_command	*cmd;
...
bool	ast_convert_tree(t_data *data, t_node *tree, t_command **head,\
	t_command **last)
{
	t_command	*left;
